...
const Employee = (props) =>{
  return (
  <div class="card mx-auto my-5"  style = {{padding: '20px 30px', backgroundColor:'#E9967A', color: '#8B0000' , width:'18rem'}}>
   ...
   <button class="btn btn-danger" onClick = {props.resetState}>Back to List</button>
  </div>
  )
}
